...
sensationApp.factory('PostsData', function(){
    ...
    /* With user-friendly permalinks configured */
     var data = { url: 'https://roomworksmedia.co.za/api/get_recent_posts' };
...
sensationApp.factory('CategoriesData', function(){
    ...
    /* With user-friendly permalinks configured */
     var data = { url: 'https://roomworksmedia.co.za/api/get_category_index',
                 category_url: 'https://roomworksmedia.co.za/api/get_category_posts?' };
